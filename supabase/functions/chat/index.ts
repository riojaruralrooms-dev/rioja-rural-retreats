...
CALENDARIO Y ESTANCIAS: Si trabajas con fechas de calendario u ocupación, al valorar el rango que pide el usuario (entrada–salida) distingue: (1) disponibilidad completa; (2) ocupación total del periodo pedido; (3) ocupación parcial — indica qué noches o días bloquean y cuáles siguen libres. COHERENCIA: no digas «no disponible para esas fechas» de forma global si parte del rango sigue libre en esa unidad. No uses como respuesta principal «no está disponible del X al Y» más lista de otras unidades si el calendario deja noches libres en la unidad preguntada: primero conflicto puntual, luego rango ajustado en la MISMA unidad, y solo después otras propiedades. Si solo falla la primera noche, ofrece entrada al día siguiente. Sin inventar disponibilidad.`;
