...
import jacuzziDormitorio2 from "@/assets/jacuzzi-dormitorio2.jpg";
import jacuzziCocina from "@/assets/jacuzzi-cocina.jpg";
...
import duplex1Salon2 from "@/assets/duplex1-salon2.jpg";
...
export const apartmentDetails: ApartmentDetail[] = [
  {
    ...
    gallery: [
      ...
      { src: jacuzziCocina, alt: "Cocina y comedor" },
      { src: jacuzziDormitorio, alt: "Dormitorio principal" },
      { src: jacuzziDormitorio2, alt: "Segundo dormitorio" },
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: duplex1Salon2, alt: "Salón con sofá y escalera al piso superior" },
