  ...
  return (
    <footer className="bg-charcoal text-cream/80 py-16">
      <div className="container mx-auto px-4">
        {/* Payment Methods & Legal Links — TOP */}
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-8 mb-12 pb-10 border-b border-cream/10">
          {/* Payment Methods */}
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-3">
              ...
              <Link to="/alojamientos" className="hover:text-cream transition-colors">Alojamientos</Link>
              <Link to="/experiencias" className="hover:text-cream transition-colors">Experiencias</Link>
              <Link to="/galeria" className="hover:text-cream transition-colors">Galería</Link>
              <Link to="/contacto" className="hover:text-cream transition-colors">Contacto</Link>
            </nav>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              <a href="tel:+34640918592" className="flex items-center gap-3 hover:text-cream transition-colors">
                <Phone size={18} className="text-wine-light" />
                640 918 592
              </a>
              <a href="mailto:info@riojaruralrooms.com" className="flex items-center gap-3 hover:text-cream transition-colors">
